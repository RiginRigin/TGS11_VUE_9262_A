<template>
  <div>
    <v-navigation-drawer v-model="drawer" class="grey darken-3" dark app clipped fixed temporary>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="title">TUGAS 11</v-list-item-title>
...
export default {
  data() {
    return {
      drawer: null,
      items: [
        { title: "User Controller", icon: "mdi-human-male", to: "/userController" },
        { title: "Sparepart Controller", icon: "mdi-cart", to: "/sparepartController" }
      ]
    }
  },
   methods: {
